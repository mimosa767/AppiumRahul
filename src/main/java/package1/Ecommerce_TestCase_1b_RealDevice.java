...
public class Ecommerce_TestCase_1b_RealDevice extends LocalDriverMethodRealDevice {
    ...
    public static void main (String [] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(1000);
        //driver.findElementByAndroidUIAutomator("UiScrollable(new UiSelector().resourceId(\"com.androidsample.generalstore:id/rvProductList\").scrollIntoView(new UiSelector().textMatches(\"Jordan 6 Rings\").instance(0))");
        // driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"com.androidsample.generalstore:id/rvProductList\")).scrollIntoView(new UiSelector().text(\"Jordan 6 Rings\").instance(0))");
        Thread.sleep(500);
