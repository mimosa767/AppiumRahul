...
public class Ecommerce_TestCase_1b_PerfectoTuneIn extends LocalPerfectoDriverMethodEcommerceTuneIn {

    public static void main (String [] args) throws MalformedURLException, InterruptedException {
        IOSDriver driver = LocalPerfectoDriverMethodEcommerceTuneInIOS.capabilities();
       // AndroidDriver<AndroidElement> driver = LocalPerfectoDriverMethodEcommerceTuneIn.capabilities();
        Thread.sleep(1000);
        ...
        PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
                .withProject(new Project("TuneIn Demo", "1"))
                .withJob(new Job("TuneIn Job", 1))
        ...
        try {
            Thread.sleep(500);
            reportiumClient.testStart("TuneIn Job", new TestContext("\"Sanity\", \"Smoke\", \"Penn\""));//notify reportiumClient that the test is starting
