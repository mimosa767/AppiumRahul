...
public class LocalPerfectoDriverMethodEcommerceAlta {
    ...
    public static AndroidDriver<AndroidElement> capabilities() throws MalformedURLException {
        ...
        capabilities.setCapability("appPackage", "com.volta.android");
        ...
        capabilities.setCapability("model", "Galaxy S22 P.*");
        ...
        capabilities.setCapability("resolution", "1080X2340");
