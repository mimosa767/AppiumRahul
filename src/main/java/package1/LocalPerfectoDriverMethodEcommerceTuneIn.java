...
public class LocalPerfectoDriverMethodEcommerceTuneIn {
    ...
    public static AndroidDriver<AndroidElement> capabilities() throws MalformedURLException {
        ...
        capabilities.setCapability("appPackage", "tunein.player");
        capabilities.setCapability("enableAppiumBehavior", true);
        //capabilities.setCapability("deviceSessionId","7e071e8a-acdf-4be9-a237-7c67e162b900");
        //capabilities.setCapability("deviceName", "9887E8424E31504B58");
        capabilities.setCapability("deviceName", "9889233442365A3646");
