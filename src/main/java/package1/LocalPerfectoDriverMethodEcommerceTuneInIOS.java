...
public class LocalPerfectoDriverMethodEcommerceTuneInIOS {
    ...
    public static IOSDriver capabilities() throws MalformedURLException {
        ...
        capabilities.setCapability("bundleId", "com.tunein.TuneInRadio");
        //capabilities.setCapability("enableAppiumBehavior", true);
       //capabilities.setCapability("deviceSessionId","39d7da34-6b95-40cc-b6db-2307f47100cd");
        //capabilities.setCapability("deviceName", "9887E8424E31504B58");
        capabilities.setCapability("deviceName", "00008030-000925AA2E10802E");
