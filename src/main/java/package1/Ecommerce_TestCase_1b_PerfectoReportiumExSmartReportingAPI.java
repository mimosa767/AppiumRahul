...
public class Ecommerce_TestCase_1b_PerfectoReportiumExSmartReportingAPI extends LocalPerfectoDriverMethodEcommerce {
    ...
    public static void main (String [] args) throws IOException, InterruptedException, URISyntaxException {
        ...
        final String REPORTING_SERVER_URL = "https://" + CQL_NAME + ".app.perfectomobile.com";
        ...
        PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
                .withProject(new Project("Ecommerce Purchase Scenario", "1"))
                        .withJob( new Job("Purchase Sneaker Checkout Flow", 1))
                                .withContextTags("Sanity", "Penn", "Ecommerce Purchase Feature", "Regression", "Smoke", "Android", "1.0")
        ...
        try {
            Thread.sleep(500);
            reportiumClient.testStart("Scroll through cart and make a purchase", new TestContext("\"Sanity\", \"Smoke\""));//notify reportiumClient that the test is starting
            reportiumClient.stepStart("This is the presteps to start all relevant diagnositcs");///define the logical step of the test that includes one or more actual command steps in the automation script but delineate a logical sequence of command steps
