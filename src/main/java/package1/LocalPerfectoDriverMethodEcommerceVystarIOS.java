...
public class LocalPerfectoDriverMethodEcommerceVystarIOS {

    public static IOSDriver capabilities() throws MalformedURLException {


        DesiredCapabilities capabilities = new DesiredCapabilities();
        capabilities.setCapability("bundleId", "org.vystarcu.vystar");
        capabilities.setCapability("deviceName", "00008110-001E283A14BB801E");
